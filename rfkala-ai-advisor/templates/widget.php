<div class="rfkala-ai-widget-container">
    ...
    <button id="rfkala-ai-fab" class="rfkala-ai-fab" aria-label="Chat with AI Advisor">
        <svg fill="currentColor" width="30" height="30" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 5.58 2 10c0 2.62 1.5 5.06 4 6.58v4.61l4.23-2.3C10.79 19.11 11.39 19.2 12 19.2c5.52 0 10-3.58 10-8s-4.48-8-10-8zm0 15.2c-.67 0-1.32-.08-1.96-.23l-3.32 1.8v-3.08C4.54 14.52 3 12.4 3 10c0-3.31 4.03-6 9-6s9 2.69 9 6-4.03 6-9 6z"/></svg>
    </button>
</div>
